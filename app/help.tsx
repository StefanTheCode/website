        ...
        <div className='row'>
          <div className='col-md-4 mb-4'>
            <div className="help-card">
              <div className="help-card-number">1</div>
              <h4>Pragmatic .NET Code Rules Course</h4>
          ...
          <div className='col-md-4 mb-4'>
            <div className="help-card">
              <div className="help-card-number">2</div>
              <h4>Design Patterns Ebooks</h4>
          ...
          <div className='col-md-4 mb-4'>
            <div className="help-card">
              <div className="help-card-number">3</div>
              <h4>Join {config.NewsletterSubCount}</h4>
