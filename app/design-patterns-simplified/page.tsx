        ...
        <div className="row d-md-flex no-gutters">
          ...
          <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 slider-text pt-5 float-left">
            <div className="text" >
              ...
              <EbookNewsletter/>
              <a className="lemonsqueezy-button" href='https://stefandjokic.lemonsqueezy.com/checkout/buy/d71f1003-7b56-4b96-8136-1d769f53eb79'><button className='btn btn-lg btn-primary border-radius-10px button-padding'>Download for <span className='text-green'><b> $9.95</b></span></button></a>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="row text-center">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-5 text-center">
              ...
              <a className="lemonsqueezy-button" href='https://stefandjokic.lemonsqueezy.com/checkout/buy/d71f1003-7b56-4b96-8136-1d769f53eb79'><button className='btn btn-lg btn-primary border-radius-10px mt-5 button-padding'>Download for <span className='text-green'><b> $9.95</b></span></button></a>
            </div>
          </div>
        </div>
      </section>
