...
Make a coffee and check out source code directly on my ** [GitHub repository](https://github.com/StefanTheCode/Newsletter/tree/main/6%23%20-%20Clean%20Code)**.

## dream BIG!


Also check out [6 Clean Code Practices](https://thecodeman.net/posts/6-ways-to-elevate-your-clean-code) and [SOLID Principles in .NET](https://thecodeman.net/posts/solid-principles-in-dotnet).
