...
<br>
##### <b>3. Strongly Typed Contracts:</b>
<br>
...
<br>
##### <b>5. Cross-Platform</b>
##### <b>6. Performance Monitoring</b>
##### <b>7. Backward Compatibility</b>
<br>
##### <b>...</b>
...
<br>
#####  <b>Step 1: Set Up Your Development Environment</b>
<br>
...
<br>
#####  <b>Step 2: Create a gRPC Server Application</b>
<br>
...
##### <i>"Communication with gRPC endpoints must be made through a gRPC client. To learn how to create a client, visit: [here](https://go.microsoft.com/fwlink/?linkid=2086909)" - because <b>it is not an HTTP server, but a gRPC server</b> for which you need a special client.
<br>
...
<br>
##### 3. Message – think of it kind of like a definition for a model in C#. We’re just defining a file or a class that has a bunch of properties in it. Inside the message, we can specify zero or more properties. 
<br>
##### <b>String name = 1;</b> - One stands for the order in which this property goes. Usually, we specify two messages, where the first one is for the parameter that we pass in, and the other one stands for the response.
```csharp
   // The request message containing the user's name.
message HelloRequest {
string name = 1;
...
```
<br>
##### 4. Service – This is the service that this particular proto is going to talk about.
<br>
##### Essentially it is a method <b>SayHello</b> where we pass HelloRequest message and which returns HelloReply message. It’s possible to pass and return <b>ONLY one parameter – message</b>. Because of that, we can create a nested object (message) to work with complex data, just like a model in C#.
![gRPC proto file service definiton](/images/blog/posts/unlock-the-power-of-high-performance-web-applications-with-grpc/proto-file-service-definition.png)
<br>
##### <b>Greeter Service class:</b>
<br>
##### We have the GreeterService, which inherits from Greeter.GreeterBase. We pull this from service Greeter in the proto file. But where does <b>Greeter.GreeterBase</b> come from? If you press F12 (Go to Definition) here, you get GreetGrpc.cs file.
<br>
...
<br>
##### <b>Step 3: Create a Client and Test</b>
<br>
